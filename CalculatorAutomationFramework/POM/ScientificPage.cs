...
namespace CalculatorAutomationFramework.POM
{
    public class ScientificPage : BasePage
    {
        ...
        private static readonly By SCIENTIFIC_MENU_OPTION = By.Uid(@"Scientific");
        ...
        public static void GoTo()
        {
            ...
            CalcDriver.Instance.FindElement(SCIENTIFIC_MENU_OPTION).Click();
        }

        public static bool VerifyIsAt()
        {
            var result = CalcDriver.Instance.FindElement(HEADER).Text().Equals(@"Scientific");
            return result;
        }
